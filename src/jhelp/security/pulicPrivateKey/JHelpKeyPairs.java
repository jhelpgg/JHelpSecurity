 ...
 * See RSA implementation to have an example of how do it<br>
 * <br>
...
public interface JHelpKeyPairs<PUBLIC_KEY extends JHelpPublicKey>
{
    ...
    *           Stream to decrypt
    * @param outputStream
    *           Stream where write decrypt message
    * @throws IOException
    ...
    *            On reading/writing problem
    */
   public void loadPair(String storeName, byte[] key) throws IOException;
    ...
    *            On read/write issue
    */
   public void sign(InputStream message, OutputStream signature) throws IOException;
    ...
    *            On reading/writing problem
    */
   public void storePair(String storeName, byte[] key) throws IOException;
}