      ...
      implements JHelpPublicKey
{
    ...
    * @throws IOException
    *            On reading issue
    * @see jhelp.security.pulicPrivateKey.JHelpPublicKey#deserialize(java.io.InputStream)
    */
   @Override
    ...
    * @throws IOException
    *            On read/write issue
    * @see jhelp.security.pulicPrivateKey.JHelpPublicKey#encrypt(java.io.InputStream, java.io.OutputStream)
    */
   @Override
    ...
    * @throws IOException
    *            On writing issue
    * @see jhelp.security.pulicPrivateKey.JHelpPublicKey#serialize(java.io.OutputStream)
    */
   @Override
    ...
    *            If a parameter have wrong value
    ...
    * @throws IOException
    *            On reading issue
    * @see jhelp.security.pulicPrivateKey.JHelpPublicKey#validSignature(java.io.InputStream, java.io.InputStream)
    */
   @Override
    ...
    *           {@link DynamicWriteXML} where insert
