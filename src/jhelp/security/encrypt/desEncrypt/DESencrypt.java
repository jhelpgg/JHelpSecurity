      ...
      implements JHelpEncrypt
{
    ...
    *            On read/write issue
    */
   public void decrypt(final String password, final InputStream encryptStream, final OutputStream clearStream) throws IOException
   {
    ...
    *            On read/write issue
    */
   public void encrypt(final String password, final InputStream clearStream, final OutputStream encryptStream) throws IOException
   {
